...
const DoctorCard: React.FC<Doctor> = ({ name, specialization, hospital, location, imageUrl }) => (
  <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:scale-105">
    <Image src={imageUrl} alt={name} width={300} height={300} className="w-full h-64 object-cover" />
    <div className="p-4">
    ...
    <div className="min-h-screen bg-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-8">
          ...
          <Link href="/doctors" className="text-blue-600 hover:text-blue-800 transition-colors duration-300">
            View All →
          </Link>
        </div>
