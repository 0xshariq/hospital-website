    ...
    <div className="flex space-x-4">
      {(['Bad', 'Poor', 'Average', 'Good', 'Excellent'] as Rating[]).map((rating) => (
        <button
          ...
          className={`flex flex-col items-center ${value === rating ? 'text-blue-600' : 'text-gray-400'}`}
        >
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} onReset={handleReset} className="space-y-6">
            ...
            <div>
              <button
                type="submit"
                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 my-4"
              >
                Submit
              </button>
              <button
